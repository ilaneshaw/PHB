...
#as Rdata file
save(for1DMaps,
     file =  file.path(outputFolderBirdPredsRasters, "CASFRIfor1DMaps.Rdata"))
...
#as Rdata file
   ...
   save(for2DMaps,
        file =  file.path(outputFolderBirdPredsRasters, "CASFRIfor2DMaps.Rdata"))
...
#as Rdata file
   ...
   save(for1DRes,
        file =  file.path(outputFolderBirdPredsRasters, "CASFRIfor1DRes.Rdata"))
...
#as Rdata file
   ...
   save(for2DRes,
        file =  file.path(outputFolderBirdPredsRasters, "CASFRIfor2DRes.Rdata"))
...
resTabSingle <- rbind(resTabs$BARS, resTabs$OSFL, resTabs$OVEN, resTabs$RUBL)
...
spearmanStats <- lapply(X = birdList, FUN = function(bird){
  ...
  nmRas <- eval(parse(text=paste("birdRasters$", bird, sep = "")))
   ...
   map2D <- eval(parse(text=paste("for1DMaps$", bird, sep = "")))
